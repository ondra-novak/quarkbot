...
public:
    ...
    ///wait for any event 
    virtual awaitable<Event> on_event() = 0;
    ...
    virtual awaitable<MarketEvent> on_market()  = 0;
    ///wait for any market event on specific instrument
    virtual awaitable<MarketEvent> on_market(Instrument instrument)  = 0;
